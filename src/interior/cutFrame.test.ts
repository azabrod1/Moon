...
describe('wedgeYawForOpening', () => {
  ...
  it('keeps the full yaw up to Cutaway and none at Section, tapering smoothly between', () => {
    ...
    expect(wedgeYawForOpening(openingAngleDegToRad(135), full)).toBeCloseTo(full / 2, 12);
    ...
    // Smooth: no half-degree step moves the yaw more than a hundredth of it.
    expect(largestStep).toBeLessThan(full * 0.01);
  });
