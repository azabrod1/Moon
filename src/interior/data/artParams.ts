...
const FAMILY_DEFAULT: Readonly<Record<MaterialFamily, ArtParams>> = {
  ...
  // A star: every region is a light. The palette (a deep orange to a golden yellow, and
  // past it to a yellow-white at the core) is the emission, granulated at the surface and
  // boiling in cells below, brightest at the core.
  plasma: family({ colorA: 0xff7c14, colorB: 0xffd66a, roughness: 1, metalness: 0, glow: 0, pattern: 'mottle', motion: 0.2, scale: 30, relief: 0, depthGradient: 0, ambient: 0, heatGain: 1, selfLit: true }),
