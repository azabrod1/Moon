...
export const MOONS: MoonData[] = [
  ...
  moon('Mimas', 'Saturn', 198.2, 185_520, 0xc0c0c0, { textureKey: 'mimas' }),
  moon('Enceladus', 'Saturn', 252.1, 237_948, 0xe8e8f0, { textureKey: 'enceladus' }),
  moon('Tethys', 'Saturn', 531.1, 294_619, 0xc8c8c8, { textureKey: 'tethys' }),
  moon('Calypso', 'Saturn', 10.7, 294_619, 0xc0c0b8),
  moon('Telesto', 'Saturn', 12.4, 294_619, 0xc0c0b8),
  moon('Dione', 'Saturn', 561.4, 377_396, 0xb0b0b0, { textureKey: 'dione' }),
  moon('Helene', 'Saturn', 17.6, 377_396, 0xb8b8b0),
  moon('Rhea', 'Saturn', 763.8, 527_108, 0xa8a8a0, { textureKey: 'rhea' }),
  moon('Titan', 'Saturn', 2574.7, 1_221_870, 0xc89040, { textureKey: 'titan', atmosphere: 'N₂ (thick)' }),
  moon('Hyperion', 'Saturn', 135, 1_481_009, 0xb0a080),
  moon('Iapetus', 'Saturn', 734.5, 3_560_820, 0x808060, { textureKey: 'iapetus' }),
  ...
  moon('Miranda', 'Uranus', 235.8, 129_390, 0xa0a0a0, { textureKey: 'miranda' }),
  moon('Ariel', 'Uranus', 578.9, 191_020, 0xb0b0b0, { textureKey: 'ariel' }),
  ...
  // Pluto
  moon('Charon', 'Pluto', 606, 19_591, 0x909090, { textureKey: 'charon' }),
