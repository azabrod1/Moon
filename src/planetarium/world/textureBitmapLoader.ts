...
export async function decodeBitmapTexture(blob: Blob, url: string): Promise<THREE.Texture> {
...
export function makeStreamedLoader(
  decode: (blob: Blob, url: string) => Promise<THREE.Texture>,
): TextureLoad {
