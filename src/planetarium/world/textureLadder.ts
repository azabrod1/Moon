 ...
 * per consecutive failure exactly like the colour ladder, and the trigger asks
 * again while the body still fills the view. A fetch that outlives an arrival simply applies late: the
  ...
  loadUpgradeTexture(
    ...
    (tex) => {
      ...
      const finish = () => {
        ...
        // The fetch and decode the streak counted have both succeeded; the
        // upload below has an outcome of its own and is not a download.
